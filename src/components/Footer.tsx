...
export default function Footer(){
    return(
        <footer style={{background: "radial-gradient(ellipse at bottom, #0B5029, #08311A, #04100C, #000)"}} className="relative group p-20 pb-10 text-white bg-black overflow-hidden">
