    ...
    return(
        <div className={`bg-black md:w-1/4 text-sm md:text-base p-10 text-white relative flex flex-col gap-5 rounded-3xl ${className}`}>
            ...
            <ButtonComponent className="flex items-center gap-2 z-10 justify-center">
                <span>Join</span>
                <span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.50045 10L0.769531 1.12451C7.38466 3.04617 13.5283 6.07601 18.9862 9.99974C13.5284 13.9235 7.38473 16.9535 0.769623 18.8752L3.50045 10ZM3.50045 10L11.0007 10" stroke="#0F172A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></span>
            </ButtonComponent>
