...
export default function StorySection(){
    ...
    return(
        <div className="relative group p-20 rounded-lg bg-black border border-gray-800 overflow-hidden">
            <div className="relative z-10">
                <Image src='/logo-expanded.png' alt="Logo" width={100} height={100} />
                <h3 className="text-3xl font-extrabold py-5">Our Story</h3>
                <div className="flex justify-between items-start gap-10 w-full h-72 mt-10">
                    <div className="w-1/2 h-full flex flex-col justify-between">
                        <p className="text-lg font-bold">Building Lasting Client Relationships</p>
                        <hr style={{backgroundColor: 'white', border: 'none', height: '1px', width: '100%'}} className="my-5"/>
                        <p className="text-lg font-bold">Catalyzing Community Transformation</p>
                        <hr style={{backgroundColor: 'white', border: 'none', height: '1px', width: '100%'}} className="my-5"/>
                        <p className="text-lg font-bold">Supporting Local Businesses in Key Economic Hubs</p>
                        <hr style={{backgroundColor: 'white', border: 'none', height: '1px', width: '100%'}} className="my-5"/>
                    </div>
                    <div className="space-y-5 w-1/2 h-full font-light">
                ...
                {data.length !== 0 && <div className="flex justify-between">
                    <div className="flex gap-5 justify-center items-center">
                        ...
                        <div className="space-y-1">
                            <h3 className="font-extrabold text-xl">{data[page - 1].name}</h3>
                            <p className="w-2/3 text-sm">{data[page - 1].occupation}</p>
                        </div>
                    </div>
