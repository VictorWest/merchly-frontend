...
export default function LandingHero(){
    ...
    return(
        <div className="pt-30 bg-[#2A2A2D]">
            <div className="relative pb-10"> 
                <div  className="text-center space-y-7 flex flex-col justify-center bg-[url('/grid.png')] bg-cover">
                    <SlideUp duration={.7}><h1 className="text-4xl font-extrabold w-2/5 mx-auto">Simplified payment solution with customized experience</h1></SlideUp>
                    <SlideUp duration={.7}><p className="text-sm w-2/5 mx-auto">Revolutionizing payment processing for small businesses in the U.S with customized payment services & infrastructure according your business needs</p></SlideUp>
                    <SlideUp duration={.7}><div className="text-xs flex justify-center gap-3 *:flex *:w-fit *:items-center *:gap-1">
                    ...
                    <SlideUp duration={.7}><ButtonComponent className="mx-auto w-fit">Get a free quote</ButtonComponent></SlideUp>
                </div>
                <section className="flex flex-col justify-center items-center mt-7">
                    {!showOpenCard && (
                        <motion.div initial={{opacity:1}} whileInView={{opacity:0}} transition={{duration:.2}} ><Image src="/cards-closed.png" alt="Extended Logo" width={500} height={500} /></motion.div>
                    )}
                    <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:.2}}><Image src="/cards.png" alt="Extended Logo" width={500} height={500} /></motion.div>
