      ...
      <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{type:'spring', duration:3}} className="flex flex-col md:flex-row ml-auto gap-15 md:gap-5 *:items-center *:md:items-start *:text-center *:md:text-start px-10 md:px-0 text-sm md:text-base">
        <InfoCard 
          svg={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M29 16C29 18.7614 26.7614 21 24 21C21.2385 21 19 18.7614 19 16C19 13.2386 21.2385 11 24 11C26.7614 11 29 13.2386 29 16Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M14.0015 34.8243C14.0952 29.3825 18.5358 25 24 25C29.4643 25 33.9049 29.3827 33.9984 34.8247C30.9547 36.2214 27.5685 37 24.0004 37C20.4319 37 17.0454 36.2212 14.0015 34.8243Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>}
        ...
        <InfoCard 
          svg={<svg width="49" height="48" viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M28.3333 22C28.3333 24.2091 26.5424 26 24.3333 26C22.1241 26 20.3333 24.2091 20.3333 22C20.3333 19.7909 22.1241 18 24.3333 18C26.5424 18 28.3333 19.7909 28.3333 22Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M34.3333 22C34.3333 31.5228 24.3333 37 24.3333 37C24.3333 37 14.3333 31.5228 14.3333 22C14.3333 16.4772 18.8104 12 24.3333 12C29.8561 12 34.3333 16.4772 34.3333 22Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>}
