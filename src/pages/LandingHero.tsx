    ...
    return(
        ...
        <div className="relative pb-10"> 
            <main className="text-center space-y-7 flex flex-col justify-center bg-[url('/grid.png')] bg-cover">
                <h1 className="text-4xl font-extrabold px-[24rem]">Simplified payment solution with customized experience</h1>
                <p className="text-xs px-[24rem]">Revolutionizing payment processing for small businesses in the U.S with customized payment services & infrastructure according your business needs</p>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-[#21C963] via-[#279689] to-transparent opacity-30"></div>
        </div>            
        </div>
